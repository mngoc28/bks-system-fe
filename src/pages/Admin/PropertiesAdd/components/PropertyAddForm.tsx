...
import { CreatePropertyRequest } from "@/dataHelper/property.dataHelper";
...
import { usePropertyTypesQuery, useCreatePropertyMutation } from "@/hooks/usePropertyQuery";
import { useGetUserProfileQuery } from "@/hooks/useUserQuery";
import { PropertyType } from "@/dataHelper/property.dataHelper";
...
const PropertyAddForm: React.FC = () => {
  ...
  // form data
  const [formData, setFormData] = React.useState<CreatePropertyRequest>({
    name: "",
    user_id: userId,
    province_id: 0,
    ward_id: 0,
  ...
  // handle back to properties list
  const handleBack = () =>{
    navigate(ROUTERS.PROPERTIES);
  }
  ...
  return (
    <>
      <div className="flex flex-row items-center justify-between gap-6">
        <h2 className="text-2xl font-bold">{t("properties.create_property")}</h2>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} id="name" type="text" placeholder={t("properties.property_name_placeholder")} value={field.value || ""} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} id="area" type="number" step="0.01" placeholder={t("properties.area_square_meter_placeholder")} value={field.value || 0} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} id="number_of_floors" type="number" step="1" placeholder={t("properties.number_of_floors_placeholder")} value={field.value || 0} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} id="number_of_units" type="number" step="1" placeholder={t("properties.number_of_units_placeholder")} value={field.value || 0} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} id="year_built" type="number" step="1" placeholder={t("properties.year_built_placeholder")} value={field.value || ""} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} id="address_detail" className="resize-none" placeholder={t("properties.address_detail_placeholder")} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
