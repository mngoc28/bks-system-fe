                            ...
                            <TableCell className="px-4 py-3 text-center">
                                {partner.image_1 ? (
                                    ...
                                    <img
                                        ...
                                        className="h-[150px] w-[150px] object-cover mx-auto hover:opacity-80 transition-opacity cursor-pointer"
                                    />
                                )}
                            </TableCell>
                            <TableCell className="px-4 py-3 text-slate-700">{partner.company_name}</TableCell>
