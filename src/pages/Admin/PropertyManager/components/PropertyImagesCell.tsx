...
const PropertyImagesCell = React.memo(({ propertyId, coverImageUrl }: PropertyImagesCellProps) => {
...
PropertyImagesCell.displayName = "PropertyImagesCell";

export default PropertyImagesCell;
