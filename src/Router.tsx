...
const CompanyHub = React.lazy(() => import("./pages/CompanyHub"));
const Dashboard = React.lazy(() => import("./pages/Dashboard"));
const Buildings = React.lazy(() => import("./pages/BuildingManager"));
const BookingManage = React.lazy(() => import("./pages/BookingManage"));
const BuildingsAdd = React.lazy(() => import("./pages/BuildingsAdd"));
const BuildingEdit = React.lazy(() => import("./pages/BuildingEdit"));
const BuildingDetail = React.lazy(() => import("./pages/BuildingDetail"));
const BuildingEditImages = React.lazy(() => import("./pages/BuildingEdit"));
const Rooms = React.lazy(() => import("./pages/RoomManager"));
const RoomAdd = React.lazy(() => import("./pages/RoomAdd"));
const RoomDetail = React.lazy(() => import("./pages/RoomDetail"));
const RoomImageManager = React.lazy(() => import("./pages/RoomImageManager"));
const RoomUpdate = React.lazy(() => import("./pages/RoomUpdate"));
const ResetPassword = React.lazy(() => import("./pages/ResetPassword"));
const ForgotPassword = React.lazy(() => import("./pages/ForgotPassword"));
const UserManagement = React.lazy(() => import("./pages/UserManager"));
const UserDetail = React.lazy(() => import("./pages/UserDetail"));
const UserEdit = React.lazy(() => import("./pages/UserEdit"));
const ProvinceManage = React.lazy(() => import("./pages/ProvinceManage"));
const ProvinceDetail = React.lazy(() => import("./pages/ProvinceDetail"));
const AmenityManagement = React.lazy(() => import("./pages/AmenityManager"));
const QuestionDetail = React.lazy(() => import("./pages/QuestionDetail"));
const QuestionManagement = React.lazy(() => import("./pages/QuestionManager"));
const QuestionCreate = React.lazy(() => import("./pages/QuestionCreate"));
const QuestionUpdate = React.lazy(() => import("./pages/QuestionUpdate"));
const QuestionFlow = React.lazy(() => import("./pages/QuestionFlow"));
const ServiceManagement = React.lazy(() => import("./pages/ServiceManagement"));
const VerifyEmailToken = React.lazy(() => import("./pages/VerifyEmailToken"));
const ResetTokenSuccess = React.lazy(() => import("./pages/ResetTokenSuccess"));
const SetPassword = React.lazy(() => import("./pages/SetPassword"));
const News = React.lazy(() => import("./pages/NewsManager"));
const NewsDetail = React.lazy(() => import("./pages/NewsDetail"));
const NewsEdit = React.lazy(() => import("./pages/NewsEdit"));
const NewsAdd = React.lazy(() => import("./pages/NewsAdd"));
